		...
		<form className='flex items-center justify-center'>
			<div className='relative w-full'>
				...
				<input
					type='text'
					id='simple-search'
					className='bg-gray-50 border mt-3 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2.5   dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
